...
void main3() {
	...
	1bit : 0 또는 1(한글자)
	2bit : 00,01,10,11중 하나를 저장할 수 있음
	...
	c언어 : 옛날 컴퓨터가 아주 성능이 나쁘고 용량이 적을때 만들어진 언어

	== 변수 ==
	변수 : 데이터를 저장할 수 있는 저장공간 (프로그래밍), 변하는 수(수학)
	...
	*/
	...
	double var3 = 3.14;                                // 8byte 공간에 3.14라는 소수점 있는 숫자를 저장
	char var4[100] = "안녕하세요 반갑습니다.";         // 1byte 공간을 256개 연결
	printf("숫자는 %d! \n", var2);
	printf("문자는 %c! \n", var1);
	printf("소수점 있는 숫자는 %f! \n", var3);
	printf("문자열은 %s! \n", var4);
